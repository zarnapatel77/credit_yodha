    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
              ...
              child: Align(
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      CommonText(title: '.com',fontSize: 9.sp,clrfont: AppColors.white,),
                      // Text(
                      //   style: TextStyle(
                      //     fontSize: 9,
              ...
              child: Row(
                children: [
                  CommonText(
                    ...
                    textStyle: TextStyles.bold.copyWith(color: AppColors.black,fontSize: 13.sp),
                  ),
                ],
              ),
            ),
          ...
          //               child: Text(
          //                 style: TextStyle(color: AppColors.clr858585,),
          //                 ' +91'
          //               ),
          //             ),
          //           ),
          ...
          //       ),
          //       ),
              Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(10.r),color: AppColors.white,),
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: Padding(
                      ...
                      child: mobileNumberController.text.length == 10 ? SvgPicture.asset(
              ...
              child: Row(
                children: [
                  const Expanded(
                    child: Column(
                      children: [
                        Divider(color: AppColors.clr858585,)
                      ],
                    ),
                  ),
              Container(
                  ...
                  CommonText(
                    ...
                    textStyle: TextStyles.regular.copyWith(color: AppColors.clr858585,fontSize: 12.sp),
                  ),
                ),
                  const Expanded(
                child: Column(
                  ...
                  style: ButtonStyle(
                    ...
                    shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                      RoundedRectangleBorder(
                        ...
                        side: BorderSide(
                            color: AppColors.clr858585, width: 0.5.w,),
                      ),
                    ),
                  ),
                ...
                SizedBox(
                  ...
                  Center(
                    child: RichText(textAlign: TextAlign.center,
                      text: TextSpan(
                        text: AppString.keyByContinuing, // Default text
                        style: TextStyles.regular.copyWith(color: Colors.black, fontSize: 10.sp),
                        children: <TextSpan>[
                          TextSpan(
                            text: AppString.keyPrivacyPolicy,
                            style: TextStyles.regular.copyWith(color: Colors.blue,fontSize: 10.sp),
                          ),
                          TextSpan(
